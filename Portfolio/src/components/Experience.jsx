  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} sm:pl-16 pl-[2rem]`}>What I've done so far</p>
        ...
        <VerticalTimeline className="vertical-timeline-custom-line">
          ...
          >
            <button
              ...
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1480bHairLvMOktXi_AWI6usMFtElaJQw/view?usp=drive_link", //paste the link to your resume here
                  "_blank"
                )
              }
              onMouseOver={() => {
